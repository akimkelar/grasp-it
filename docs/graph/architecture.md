...
| `Risk` | Potential negative outcome (code-visible hazard or specialist-identified risk) | `risk:<kebab-name>` |
...
| `Risk` | Potential negative outcome (specialist-identified risk) | `risk:<kebab-name>` |
| `Constraint` | Technical invariant or access condition stated by specialist | `constraint:<kebab-name>` |
