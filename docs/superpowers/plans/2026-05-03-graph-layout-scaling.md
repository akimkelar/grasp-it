...
**Files:**
- Modify: `grasp-it-plugin/packages/dashboard/package.json`
- Create: `grasp-it-plugin/packages/dashboard/src/utils/__tests__/smoke.test.ts`
- Modify: `grasp-it-plugin/packages/dashboard/vite.config.ts`

- [ ] **Step 1: Add deps and devDeps to package.json**

Edit `grasp-it-plugin/packages/dashboard/package.json`. Add to `dependencies`:
...
In `grasp-it-plugin/packages/dashboard/vite.config.ts` add a triple-slash reference at the top and a `test` block. Open the file, then at the very top add:
...
```bash
pnpm --filter @grasp-it/dashboard test
```
...
```bash
git add grasp-it-plugin/packages/dashboard/package.json \
        grasp-it-plugin/packages/dashboard/vite.config.ts \
        grasp-it-plugin/packages/dashboard/src/utils/__tests__/smoke.test.ts \
        pnpm-lock.yaml
...
**Files:**
- Create: `grasp-it-plugin/packages/dashboard/src/utils/containers.ts`
- Create: `grasp-it-plugin/packages/dashboard/src/utils/__tests__/containers.test.ts`
...
import type { GraphNode, GraphEdge } from "@grasp-it/core/types";
...
```bash
pnpm --filter @grasp-it/dashboard test containers
```
...
Create `grasp-it-plugin/packages/dashboard/src/utils/louvain.ts`:

```ts
import type { GraphEdge } from "@grasp-it/core/types";
...
```bash
git add grasp-it-plugin/packages/dashboard/src/utils/containers.ts \
        grasp-it-plugin/packages/dashboard/src/utils/louvain.ts \
        grasp-it-plugin/packages/dashboard/src/utils/__tests__/containers.test.ts
...
**Files:**
- Modify: `grasp-it-plugin/packages/dashboard/src/utils/louvain.ts`
- Modify: `grasp-it-plugin/packages/dashboard/src/utils/__tests__/containers.test.ts`
...
Overwrite `grasp-it-plugin/packages/dashboard/src/utils/louvain.ts`:
...
```bash
git add grasp-it-plugin/packages/dashboard/src/utils/louvain.ts \
        grasp-it-plugin/packages/dashboard/src/utils/__tests__/containers.test.ts
...
**Files:**
- Modify: `grasp-it-plugin/packages/dashboard/src/utils/edgeAggregation.ts`
- Create: `grasp-it-plugin/packages/dashboard/src/utils/__tests__/edgeAggregation.test.ts`
...
```bash
pnpm --filter @grasp-it/dashboard test edgeAggregation
```
...
Append to `grasp-it-plugin/packages/dashboard/src/utils/edgeAggregation.ts`:
...
```bash
git add grasp-it-plugin/packages/dashboard/src/utils/edgeAggregation.ts \
        grasp-it-plugin/packages/dashboard/src/utils/__tests__/edgeAggregation.test.ts
...
**Files:**
- Create: `grasp-it-plugin/packages/dashboard/src/utils/elk-layout.ts`
- Create: `grasp-it-plugin/packages/dashboard/src/utils/__tests__/elk-layout.test.ts`
...
```bash
pnpm --filter @grasp-it/dashboard test elk-layout
```
...
```ts
import ELK from "elkjs/lib/elk.bundled.js";
import type { GraphIssue } from "@grasp-it/core/schema";
...
```bash
git add grasp-it-plugin/packages/dashboard/src/utils/elk-layout.ts \
        grasp-it-plugin/packages/dashboard/src/utils/__tests__/elk-layout.test.ts
...
**Files:**
- Modify: `grasp-it-plugin/packages/dashboard/src/utils/__tests__/elk-layout.test.ts`
...
```bash
git add grasp-it-plugin/packages/dashboard/src/utils/__tests__/elk-layout.test.ts
...
Open `grasp-it-plugin/packages/dashboard/src/store.ts` and locate the `DashboardStore` interface (around line 62) and the `create<DashboardStore>` initializer.
...
```bash
pnpm --filter @grasp-it/dashboard build
```
...
**Files:**
- Create: `grasp-it-plugin/packages/dashboard/src/components/ContainerNode.tsx`
...
```bash
git add grasp-it-plugin/packages/dashboard/src/components/ContainerNode.tsx
...
git add grasp-it-plugin/packages/dashboard/src/components/GraphView.tsx \
        grasp-it-plugin/packages/dashboard/src/utils/layout.ts
...
**Files:**
- Modify: `grasp-it-plugin/packages/dashboard/src/components/DomainGraphView.tsx`
...
```bash
git add grasp-it-plugin/packages/dashboard/src/components/GraphView.tsx \
        grasp-it-plugin/packages/dashboard/src/store.ts
...
**Files:**
- Modify: `grasp-it-plugin/packages/dashboard/src/components/WarningBanner.tsx`
- Modify: `grasp-it-plugin/packages/dashboard/src/components/GraphView.tsx`
- Modify: `grasp-it-plugin/packages/dashboard/src/store.ts`
...
const lines = hasFatal
  ? [
      ...
      "Please file an issue at github.com/akimkelar/Grasp-It/issues with the text below.",
      "",
    ]
  : [
...
```bash
git add grasp-it-plugin/packages/dashboard/src/components/WarningBanner.tsx \
        grasp-it-plugin/packages/dashboard/src/components/GraphView.tsx \
...
**Files:**
- Create: `grasp-it-plugin/packages/dashboard/scripts/benchmark-layout.mjs`
...
```bash
node grasp-it-plugin/packages/dashboard/scripts/benchmark-layout.mjs
```
...
```bash
git add grasp-it-plugin/packages/dashboard/scripts/benchmark-layout.mjs
