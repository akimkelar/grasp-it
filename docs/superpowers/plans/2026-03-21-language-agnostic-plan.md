...
**Goal:** Make Grasp-It language-agnostic by introducing a config-driven language framework, replacing the TS-only tree-sitter plugin, and creating language-aware prompts for 12 languages.
...
**Files:**
- Create: `grasp-it-plugin/packages/core/src/languages/types.ts`

**Step 1: Write the failing test**

Create: `grasp-it-plugin/packages/core/src/languages/__tests__/types.test.ts`
...
Run: `cd grasp-it-plugin && pnpm --filter @grasp-it/core test -- --run src/languages/__tests__/types.test.ts`
...
**Files:**
- Create: `grasp-it-plugin/packages/core/src/languages/registry.ts`

**Step 1: Write the failing test**

Create: `grasp-it-plugin/packages/core/src/languages/__tests__/registry.test.ts`
...
Run: `cd grasp-it-plugin && pnpm --filter @grasp-it/core test -- --run src/languages/__tests__/registry.test.ts`
Expected: FAIL — module `../registry.js` not found

**Step 3: Write minimal implementation**

```typescript
// grasp-it-plugin/packages/core/src/languages/registry.ts
import { LanguageConfigSchema } from "./types.js";
import type { LanguageConfig } from "./types.js";
...
**Files:**
- Create: `grasp-it-plugin/packages/core/src/languages/configs/typescript.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/javascript.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/python.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/go.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/java.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/rust.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/cpp.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/csharp.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/ruby.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/php.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/swift.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/kotlin.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/index.ts`

**Step 1: Write the failing test**

Create: `grasp-it-plugin/packages/core/src/languages/__tests__/configs.test.ts`
...
Run: `cd grasp-it-plugin && pnpm --filter @grasp-it/core test -- --run src/languages/__tests__/configs.test.ts`
...
```bash
git add grasp-it-plugin/packages/core/src/languages/configs/
...
**Files:**
- Create: `grasp-it-plugin/packages/core/src/languages/index.ts`
- Modify: `grasp-it-plugin/packages/core/src/index.ts`

**Step 1: Create barrel export**

```typescript
// grasp-it-plugin/packages/core/src/languages/index.ts
...
Add to `grasp-it-plugin/packages/core/src/index.ts`:
...
Run: `cd grasp-it-plugin && pnpm --filter @grasp-it/core build`
Expected: Build succeeds with no errors

**Step 4: Commit**

```bash
git add grasp-it-plugin/packages/core/src/languages/index.ts grasp-it-plugin/packages/core/src/index.ts
...
Run:
```bash
cd grasp-it-plugin && pnpm --filter @grasp-it/core add \
  tree-sitter-python \
  tree-sitter-go \
  tree-sitter-java \
  tree-sitter-rust \
...
```bash
cd grasp-it-plugin && for lang in python go java rust cpp c-sharp ruby php swift kotlin; do
...
```bash
git add grasp-it-plugin/packages/core/package.json grasp-it-plugin/pnpm-lock.yaml
...
**Files:**
- Create: `grasp-it-plugin/packages/core/src/plugins/generic-tree-sitter-plugin.ts`

**Step 1: Write the failing test**

Create: `grasp-it-plugin/packages/core/src/plugins/generic-tree-sitter-plugin.test.ts`
...
Run: `cd grasp-it-plugin && pnpm --filter @grasp-it/core test -- --run src/plugins/generic-tree-sitter-plugin.test.ts`
Expected: FAIL — module not found
...
```bash
git add grasp-it-plugin/packages/core/src/plugins/generic-tree-sitter-plugin.ts
git add grasp-it-plugin/packages/core/src/plugins/generic-tree-sitter-plugin.test.ts
...
**Files:**
- Modify: `grasp-it-plugin/packages/core/src/plugins/generic-tree-sitter-plugin.test.ts`
...
**Files:**
- Modify: `grasp-it-plugin/packages/core/src/index.ts`
- Modify: `grasp-it-plugin/packages/core/src/plugins/registry.ts`
- Delete: `grasp-it-plugin/packages/core/src/plugins/tree-sitter-plugin.ts` (after confirming no other imports)

**Step 1: Update core exports**

In `grasp-it-plugin/packages/core/src/index.ts`:
...
In `grasp-it-plugin/packages/core/src/plugins/registry.ts`:
...
Run: `grep -r "TreeSitterPlugin" grasp-it-plugin/`

Update each import to use `GenericTreeSitterPlugin`. The main consumers are:
- `grasp-it-plugin/packages/core/src/index.ts`
...
Run: `rm grasp-it-plugin/packages/core/src/plugins/tree-sitter-plugin.ts`

Keep the old test file temporarily — rename it to verify parity.

**Step 5: Run full test suite**

Run: `cd grasp-it-plugin && pnpm --filter @grasp-it/core test`
Expected: ALL PASS
...
**Files:**
- Modify: `grasp-it-plugin/packages/core/src/analyzer/language-lesson.ts`
- Modify: `grasp-it-plugin/packages/core/src/__tests__/language-lesson.test.ts`
...
Run: `cd grasp-it-plugin && pnpm --filter @grasp-it/core test -- --run src/__tests__/language-lesson.test.ts`
...
```bash
git add grasp-it-plugin/packages/core/src/analyzer/language-lesson.ts
git add grasp-it-plugin/packages/core/src/__tests__/language-lesson.test.ts
...
**Files:**
- Create: `grasp-it-plugin/skills/understand/languages/typescript.md`
- Create: `grasp-it-plugin/skills/understand/languages/javascript.md`
- Create: `grasp-it-plugin/skills/understand/languages/python.md`
- Create: `grasp-it-plugin/skills/understand/languages/go.md`
- Create: `grasp-it-plugin/skills/understand/languages/java.md`
- Create: `grasp-it-plugin/skills/understand/languages/rust.md`
- Create: `grasp-it-plugin/skills/understand/languages/cpp.md`
- Create: `grasp-it-plugin/skills/understand/languages/csharp.md`
- Create: `grasp-it-plugin/skills/understand/languages/ruby.md`
- Create: `grasp-it-plugin/skills/understand/languages/php.md`
- Create: `grasp-it-plugin/skills/understand/languages/swift.md`
- Create: `grasp-it-plugin/skills/understand/languages/kotlin.md`
...
**Files:**
- Modify: `grasp-it-plugin/skills/understand/SKILL.md` (the `/understand` skill definition)
...
**Files:**
- Modify or Delete: `grasp-it-plugin/packages/core/src/plugins/tree-sitter-plugin.test.ts`
...
Run: `cd grasp-it-plugin && pnpm --filter @grasp-it/skill build`
Expected: PASS

**Step 3: Build dashboard**

Run: `cd grasp-it-plugin && pnpm --filter @grasp-it/dashboard build`
Expected: PASS (dashboard doesn't import language modules directly)

**Step 4: Run lint**

Run: `cd grasp-it-plugin && pnpm lint`
Expected: PASS (or fix any lint issues)

**Step 5: Run all tests**

Run: `cd grasp-it-plugin && pnpm --filter @grasp-it/core test && pnpm --filter @grasp-it/skill test`
Expected: ALL PASS
