...
**Design doc:** `docs/plans/2026-03-28-grasp-it-extension-design.md`
...
**Files:**
- Modify: `grasp-it-plugin/packages/core/src/types.ts:1-116`
- Test: `grasp-it-plugin/packages/core/src/types.test.ts`
...
Run: `pnpm --filter @grasp-it/core test -- --run types.test`
...
```bash
git add grasp-it-plugin/packages/core/src/types.ts grasp-it-plugin/packages/core/src/types.test.ts
...
**Files:**
- Modify: `grasp-it-plugin/packages/core/src/schema.ts:1-554`
- Test: `grasp-it-plugin/packages/core/src/__tests__/schema.test.ts`
...
Run: `pnpm --filter @grasp-it/core test -- --run schema.test`
...
```bash
git add grasp-it-plugin/packages/core/src/schema.ts grasp-it-plugin/packages/core/src/__tests__/schema.test.ts
...
**Files:**
- Modify: `grasp-it-plugin/packages/core/src/plugins/registry.ts:1-76`
- Test: `grasp-it-plugin/packages/core/src/__tests__/plugin-registry.test.ts`
...
Run: `pnpm --filter @grasp-it/core test -- --run plugin-registry.test`
...
```bash
git add grasp-it-plugin/packages/core/src/plugins/registry.ts grasp-it-plugin/packages/core/src/__tests__/plugin-registry.test.ts
...
**Files:**
- Create: `grasp-it-plugin/packages/core/src/languages/configs/markdown.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/yaml.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/json-config.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/toml.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/env.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/xml.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/dockerfile.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/sql.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/graphql.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/protobuf.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/terraform.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/github-actions.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/makefile.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/shell.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/html.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/css.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/openapi.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/kubernetes.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/docker-compose.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/json-schema.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/csv.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/restructuredtext.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/powershell.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/batch.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/jenkinsfile.ts`
- Create: `grasp-it-plugin/packages/core/src/languages/configs/plaintext.ts`
- Modify: `grasp-it-plugin/packages/core/src/languages/configs/index.ts`
- Test: `grasp-it-plugin/packages/core/src/__tests__/language-registry.test.ts`
...
Run: `pnpm --filter @grasp-it/core test -- --run language-registry.test`
...
```bash
git add grasp-it-plugin/packages/core/src/languages/
...
**Files:**
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/markdown-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/yaml-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/json-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/toml-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/env-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/dockerfile-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/sql-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/graphql-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/protobuf-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/terraform-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/makefile-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/shell-parser.ts`
- Create: `grasp-it-plugin/packages/core/src/plugins/parsers/index.ts`
- Test: `grasp-it-plugin/packages/core/src/__tests__/parsers.test.ts`
...
Run: `pnpm --filter @grasp-it/core test -- --run parsers.test`
...
```bash
cd grasp-it-plugin/packages/core
...
```bash
git add grasp-it-plugin/packages/core/src/plugins/parsers/ grasp-it-plugin/packages/core/src/__tests__/parsers.test.ts grasp-it-plugin/packages/core/package.json grasp-it-plugin/packages/core/pnpm-lock.yaml
...
**Files:**
- Modify: `grasp-it-plugin/packages/core/src/analyzer/graph-builder.ts:1-207`
- Test: `grasp-it-plugin/packages/core/src/analyzer/graph-builder.test.ts`
...
Run: `pnpm --filter @grasp-it/core test -- --run graph-builder.test`
...
```bash
git add grasp-it-plugin/packages/core/src/analyzer/graph-builder.ts grasp-it-plugin/packages/core/src/analyzer/graph-builder.test.ts
...
**Files:**
- Modify: `grasp-it-plugin/packages/core/src/index.ts`
...
Run: `pnpm --filter @grasp-it/core build`
Expected: Success, no errors

**Step 3: Commit**

```bash
git add grasp-it-plugin/packages/core/src/index.ts
...
**Files:**
- Modify: `grasp-it-plugin/skills/understand/project-scanner-prompt.md`
...
```bash
git add grasp-it-plugin/skills/understand/project-scanner-prompt.md
...
**Files:**
- Modify: `grasp-it-plugin/skills/understand/file-analyzer-prompt.md`
...
```bash
git add grasp-it-plugin/skills/understand/file-analyzer-prompt.md
...
**Files:**
- Modify: `grasp-it-plugin/skills/understand/architecture-analyzer-prompt.md`
...
```bash
git add grasp-it-plugin/skills/understand/architecture-analyzer-prompt.md
...
**Files:**
- Modify: `grasp-it-plugin/skills/understand/tour-builder-prompt.md`
...
```bash
git add grasp-it-plugin/skills/understand/tour-builder-prompt.md
...
**Files:**
- Modify: `grasp-it-plugin/skills/understand/graph-reviewer-prompt.md`
...
```bash
git add grasp-it-plugin/skills/understand/graph-reviewer-prompt.md
...
**Files:**
- Create: `grasp-it-plugin/skills/understand/languages/markdown.md`
- Create: `grasp-it-plugin/skills/understand/languages/yaml.md`
- Create: `grasp-it-plugin/skills/understand/languages/json.md`
- Create: `grasp-it-plugin/skills/understand/languages/sql.md`
- Create: `grasp-it-plugin/skills/understand/languages/dockerfile.md`
- Create: `grasp-it-plugin/skills/understand/languages/terraform.md`
- Create: `grasp-it-plugin/skills/understand/languages/graphql.md`
- Create: `grasp-it-plugin/skills/understand/languages/protobuf.md`
- Create: `grasp-it-plugin/skills/understand/languages/shell.md`
- Create: `grasp-it-plugin/skills/understand/languages/html.md`
- Create: `grasp-it-plugin/skills/understand/languages/css.md`
...
```bash
git add grasp-it-plugin/skills/understand/languages/
...
**Files:**
- Modify: `grasp-it-plugin/packages/dashboard/src/themes/presets.ts:1-143`
...
```bash
git add grasp-it-plugin/packages/dashboard/src/themes/presets.ts
...
**Files:**
- Modify: `grasp-it-plugin/packages/dashboard/src/components/CustomNode.tsx:1-137`
...
```bash
git add grasp-it-plugin/packages/dashboard/src/components/CustomNode.tsx
...
**Files:**
- Modify: `grasp-it-plugin/packages/dashboard/src/components/NodeInfo.tsx:1-312`
...
```bash
git add grasp-it-plugin/packages/dashboard/src/components/NodeInfo.tsx
...
**Files:**
- Modify: `grasp-it-plugin/packages/dashboard/src/components/ProjectOverview.tsx`
...
```bash
git add grasp-it-plugin/packages/dashboard/src/components/ProjectOverview.tsx
...
**Files:**
- Modify: `grasp-it-plugin/packages/dashboard/src/store.ts`
- Modify: `grasp-it-plugin/packages/dashboard/src/components/GraphView.tsx`
- Modify: `grasp-it-plugin/packages/dashboard/src/App.tsx`
...
```bash
git add grasp-it-plugin/packages/dashboard/src/store.ts grasp-it-plugin/packages/dashboard/src/components/GraphView.tsx grasp-it-plugin/packages/dashboard/src/App.tsx
...
Run: `pnpm --filter @grasp-it/dashboard build`
...
**Files:**
- Modify: `grasp-it-plugin/package.json` → bump version
...
```bash
git add grasp-it-plugin/package.json .claude-plugin/marketplace.json .claude-plugin/plugin.json .cursor-plugin/plugin.json
