...
- Modify: `grasp-it-plugin/packages/dashboard/src/components/LearnPanel.tsx`
- Modify: `grasp-it-plugin/packages/dashboard/src/components/ProjectOverview.tsx`
- Modify: `grasp-it-plugin/packages/dashboard/src/components/SearchBar.tsx`
- Modify: `grasp-it-plugin/packages/dashboard/src/components/LayerLegend.tsx`
- Modify: `grasp-it-plugin/packages/dashboard/src/components/PersonaSelector.tsx`
- Modify: `grasp-it-plugin/packages/dashboard/src/components/CodeViewer.tsx`
...
Run: `cd grasp-it-plugin && pnpm dev:dashboard`
...
**Files:**
- Create: `grasp-it-plugin/packages/dashboard/src/themes/types.ts`
...
**Files:**
- Create: `grasp-it-plugin/packages/dashboard/src/themes/presets.ts`
...
**Files:**
- Create: `grasp-it-plugin/packages/dashboard/src/themes/theme-engine.ts`
...
**Files:**
- Create: `grasp-it-plugin/packages/dashboard/src/themes/ThemeContext.tsx`
...
Create: `grasp-it-plugin/packages/dashboard/src/themes/index.ts`
...
**Files:**
- Create: `grasp-it-plugin/packages/dashboard/src/components/ThemePicker.tsx`
