...
```bash
cd /Users/yuxianglin/Desktop/opensource/Grasp-It/homepage
pnpm install
pnpm build
```
...
@font-face {
  ...
  src: url('/Grasp-It/fonts/DMSerifDisplay-Regular.woff2') format('woff2');
  font-weight: 400;
  font-style: normal;
  font-display: swap;
}
...
@font-face {
  font-family: 'Inter';
  src: url('/Grasp-It/fonts/Inter-Regular.woff2') format('woff2');
  font-weight: 400;
  font-style: normal;
  font-display: swap;
}
...
@font-face {
  font-family: 'Inter';
  src: url('/Grasp-It/fonts/Inter-SemiBold.woff2') format('woff2');
  font-weight: 600;
  font-style: normal;
  font-display: swap;
}
...
@font-face {
  ...
  src: url('/Grasp-It/fonts/JetBrainsMono-Regular.woff2') format('woff2');
  font-weight: 400;
  font-style: normal;
  font-display: swap;
}
...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/svg+xml" href="/Grasp-It/favicon.svg" />
    <title>{title}</title>
  </head>
  <body>
    <slot />
...
```astro
---
const githubUrl = 'https://github.com/akimkelar/Grasp-It';
---

<nav class="nav" id="nav">
  <div class="nav-inner">
    <a href="/Grasp-It/" class="nav-logo">Understand Anything</a>
    <div class="nav-links">
...
```bash
mkdir -p /Users/yuxianglin/Desktop/opensource/Grasp-It/homepage/public/images
cp /Users/yuxianglin/Desktop/opensource/Grasp-It/assets/hero.jpg /Users/yuxianglin/Desktop/opensource/Grasp-It/homepage/public/images/hero.jpg
```
...
<section class="hero">
  <div class="hero-bg">
    <img src="/Grasp-It/images/hero.jpg" alt="" class="hero-bg-img" loading="eager" />
...
```bash
cp /Users/yuxianglin/Desktop/opensource/Grasp-It/assets/overview.png /Users/yuxianglin/Desktop/opensource/Grasp-It/homepage/public/images/overview.png
```
...
<section class="showcase">
  ...
  <div class="showcase-frame reveal reveal-delay-1">
    ...
    <img
      src="/Grasp-It/images/overview.png"
...
<section class="install" id="install">
  <div class="install-inner reveal">
    ...
    <div class="install-code">
      ...
      <pre><code><span class="cmd">/plugin marketplace add</span> akimkelar/Grasp-It
<span class="cmd">/plugin install</span> grasp-it
...
```bash
mkdir -p /Users/yuxianglin/Desktop/opensource/Grasp-It/.github/workflows
```
...
```markdown
**[Homepage](https://grasp-it.com)** | **[GitHub](https://github.com/akimkelar/Grasp-It)**
```
