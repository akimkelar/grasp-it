...
**Date**: 2026-03-18
**Status**: Approved
**Goal**: Make Grasp-It skills work across Codex, OpenClaw, OpenCode, and Cursor with zero build step — same files everywhere.
...
```
Fetch and follow instructions from https://raw.githubusercontent.com/akimkelar/Grasp-It/refs/heads/main/grasp-it-plugin/.codex/INSTALL.md
```
