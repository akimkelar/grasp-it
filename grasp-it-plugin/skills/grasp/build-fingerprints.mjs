 ...
 * (Phase 7 step 2.5), generating .grasp-it/fingerprints.json.
 *
 ...
 *
 * Writes: <projectRoot>/.grasp-it/fingerprints.json
...
// ---------------------------------------------------------------------------
// Resolve @grasp-it/core (matches extract-structure.mjs).
