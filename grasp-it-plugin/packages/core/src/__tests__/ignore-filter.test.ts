...
describe("IgnoreFilter", () => {
  ...
  describe("createIgnoreFilter with user .graspignore", () => {
    it("reads patterns from .grasp-it/.graspignore", () => {
      writeFileSync(
        join(testDir, ".grasp-it", ".graspignore"),
        "# Exclude tests\n__tests__/\n*.test.ts\n"
      );
      const filter = createIgnoreFilter(testDir);
    ...
    it("reads patterns from project root .graspignore", () => {
      writeFileSync(
        join(testDir, ".graspignore"),
        "docs/\n"
      );
      const filter = createIgnoreFilter(testDir);
    ...
    it("merges .grasp-it/ and root .graspignore", () => {
      writeFileSync(
        join(testDir, ".grasp-it", ".graspignore"),
        "__tests__/\n"
      );
