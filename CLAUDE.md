...
- **grasp-it-plugin/** — Claude Code plugin containing all source code:
  ...
  - **src/** — Skill TypeScript source for `/grasp`, `/grasp-diff`, `/grasp-explain`, `/grasp-domain`, `/grasp-gaps`, `/grasp-knowledge`, `/grasp-concept`, `/grasp-search`
  - **skills/** — Skill definitions (`/grasp`, `/grasp-diff`, `/grasp-explain`, `/grasp-domain`, `/grasp-gaps`, `/grasp-knowledge`, `/grasp-concept`, `/grasp-search`)
